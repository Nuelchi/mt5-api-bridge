# MT5 API Bridge - Deployment Steps

## 🎯 Quick Deployment Guide

Repository: https://github.com/Nuelchi/mt5-api-bridge
...
```bash
# Run deployment script for Nginx setup
chmod +x deploy_vps.sh
./deploy_vps.sh
# When prompted, enter: trade.trainflow.dev
